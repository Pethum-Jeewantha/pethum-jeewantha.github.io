...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  "ts/main.ts": [function (require, module, exports) {
    $('.nav-link').on('click', function () {
      return $('.navbar-toggler').trigger('click');
    });
    ...
    function checkBoxes() {
      var triggerBottom = window.innerHeight / 6 * 5.5;
    ...
    var texts = ['Welcome', "I am a Full Stack Developer", 'Learner & a Competitor', 'Like to Compete With The World Which Makes Me Better Person'];
    var i = 0;
    var j = 0;
